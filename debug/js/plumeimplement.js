...
function userType2_init() {
    plumeLog("初始化userType2模板-" + plumeTime());
    plumeUtil.js(plumePath + "/js/userType2.js");
    plumeLog("完成userType2模板加载-" + plumeTime());
}
//popUpload模板初始化函数
...
function goodsDraft_init() {
    plumeLog("初始化goodsDraft模板-" + plumeTime());
